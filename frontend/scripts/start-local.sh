...
echo -e "AUTH_SERVICE_URL=http://localhost:$PORT_AUTH"
echo -e "BID_SERVICE_URL=http://localhost:$PORT_BID"
echo -e "USER_STATS_SERVICE_URL=http://localhost:$PORT_STATS"
echo -e "JWT_PUBLIC_KEY_PATH=../.data/keys/public.pem"
echo -e "----------------------------------------"
